...
/**
 * Smarty {rss2array} function plugin
 *
 * Type:     function<br>
 * Name:     rss2array<br>
...
function rss2array_save($file,$params)
{
	$rss = new rss_php;
    $rss->load($params['url']);
...
function smarty_function_rss2array($params, &$smarty)
{
	...
	$file = "../sites/".KEY."/cache/cache/".md5($params['url']).".rss2array";
	if (file_exists($file)){
		//if (filemtime($file)<time()-$duration) {
		//	$items = rss2array_save($file,$params);
		//} else {
