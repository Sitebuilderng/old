...
<form id="commentFormForm" class="commentForm clearfix" action="" method="post">
	...
	<div class="clear"></div>
	<input type="submit" name="" value="{$langs.Add_Comment}" id="addCommentButton"/> <img src="/graphics/AjaxLoader.gif" alt="" id="loader" style="display:none;margin-top:20px;margin-left:10px;margin-bottom:-13px;"/>
</form>