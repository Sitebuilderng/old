...
*}
{if $smarty.get.action=="collectpayments-feiqovlv-aslqgkbmm"}
	{setseed_website_builder
		action=cron
	}
{/if}
	...
	*}
	...
	{if $smarty.get.nobilling=="true"}
		<div id="nobilling">
			...
			<p>Before your new features can be applied you need to add a payment method to your account. Please create a billing agreement via PayPal to continue.</p>
	...
	<div id="swb_features_store" class="">
		<div id="swb_features_store_inner">
			<div id="swb_features_store_features">
				...
				<p>You can add or remove features at any time. You will not be charged until you click 'Save' below. You will be immediately charged a partial amount based on the number of days until your next billing day.</p>
					<div class="hr"></div>
				...
				<div class="swb_features_store_feature swb_feature_disabled" data-feature-dependents="unlimited_products" data-feature-name="shop">
					...
					<h3>Shop</h3>
					<p class="swb_feature_info">Add products with options, stock level, multi-tier pricing and more and sell them with a PayPal shopping basket.</p>
					<p class="swb_feature_disabled_button"><button class="swb_feature_button">Enable</button></p>
					<p class="swb_feature_enabled_button"><span>Enabled</span> <button class="swb_feature_button">Remove</button></p>
					<p class="swb_feature_included_label"><span>Included in plan</span></p>
