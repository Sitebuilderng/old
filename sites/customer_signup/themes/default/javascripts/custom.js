...
*/	
	function widows() {
		var h2Text = '';
		  $('h1,h2,h3,.Lead_Paragraph').each(function() {
	...
	$(window).resize(function(){
		imageMarginHelper();
		setRecentBlogWidths();
		homepageColumnsLineUp();
	});
	function homepageColumnsLineUp() {
		$(".page_home .row").each(function(){
			var h = 0;
			$(".threeThirdsCol p",$(this)).css("height","auto");
			
			$(".threeThirdsCol",$(this)).each(function(){
				if ($("p:first",$(this)).height()>h) {
					h= $("p:first",$(this)).height();
				}
			});
			$(".threeThirdsCol",$(this)).each(function(){
				$("p:first",$(this)).css("height",h+"px");
			});
		});
	}
