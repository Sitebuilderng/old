<?php /* Smarty version 2.6.18, created on 2017-07-02 11:32:59
         compiled from product.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'htmlspecialchars', 'product.tpl', 22, false),)), $this); ?>
...
<?php echo $this->_tpl_vars['price']; ?>
	...
	<?php if ($this->_tpl_vars['in_stock'] < $this->_tpl_vars['theme_vars_hide_stock_threshold']): ?>
	<span class="stock <?php if ($this->_tpl_vars['in_stock'] < $this->_tpl_vars['theme_vars_warning_stock_threshold']): ?>warning<?php endif; ?>"><?php echo $this->_tpl_vars['langs']['In_Stock']; ?>
...
<?php echo $this->_tpl_vars['variant']['price']; ?>
	...
	<?php if (( ! $this->_tpl_vars['separate_stock_for_options'] && $this->_tpl_vars['in_stock'] < $this->_tpl_vars['theme_vars_hide_stock_threshold'] ) || ( $this->_tpl_vars['separate_stock_for_options'] && $this->_tpl_vars['variants'][0]['stock'] < $this->_tpl_vars['theme_vars_hide_stock_threshold'] )): ?>
	<p class="stockAndPrice" data-warning-threshold="<?php echo $this->_tpl_vars['theme_vars_warning_stock_threshold']; ?>
"><span class="stock <?php if ($this->_tpl_vars['separate_stock_for_options']): ?><?php if ($this->_tpl_vars['variants'][0]['stock'] < $this->_tpl_vars['theme_vars_warning_stock_threshold']): ?>warning<?php endif; ?><?php else: ?><?php if ($this->_tpl_vars['in_stock'] < $this->_tpl_vars['theme_vars_warning_stock_threshold']): ?>warning<?php endif; ?><?php endif; ?>"><?php echo $this->_tpl_vars['langs']['In_Stock']; ?>
