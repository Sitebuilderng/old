...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'css_safe', 'form.tpl', 33, false),array('modifier', 'explode', 'form.tpl', 67, false),array('modifier', 'htmlspecialchars', 'form.tpl', 115, false),)), $this); ?>
...
<?php else: ?>
<form action="/actions/FormSend/" method="post" class="form <?php if ($this->_tpl_vars['basketForm']): ?>formProduct addToBasketForm<?php endif; ?>" enctype="multipart/form-data" >
<?php endif; ?>
...
<?php if ($this->_tpl_vars['input']['type'] != 'checkbox' && $this->_tpl_vars['input']['type'] != 'radiogroup' && $this->_tpl_vars['input']['type'] != 'heading' && $this->_tpl_vars['input']['type'] != 'text' && $this->_tpl_vars['input']['type'] != 'hidden'): ?>
<label class="label_<?php echo ((is_array($_tmp=$this->_tpl_vars['input']['label'])) ? $this->_run_mod_handler('css_safe', true, $_tmp) : smarty_modifier_css_safe($_tmp)); ?>
 <?php if ($this->_tpl_vars['input']['required'] == 'yes'): ?>required_label<?php endif; ?> type_<?php echo $this->_tpl_vars['input']['type']; ?>
...
<?php endif; ?>"/></noscript>
	...
	<p id="success" class="Icon_Tick" style="display:<?php if ($this->_tpl_vars['form_sent'] != 'true'): ?>none<?php else: ?>block<?php endif; ?>";>Thank you - this was successfully sent</p>
	<?php if ($this->_tpl_vars['basketForm']): ?>
