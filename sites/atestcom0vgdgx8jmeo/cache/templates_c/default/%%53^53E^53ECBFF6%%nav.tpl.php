...
<div class="module clearfix nav <?php if ($this->_tpl_vars['logo']): ?>logo-<?php echo $this->_tpl_vars['logo']; ?>
...
<?php endif; ?>">
	<ul class="flexibreak-container contains-text clearfix">
		...
		<li id="nav-search" class="nav-search nav-search-style-<?php echo $this->_tpl_vars['search_style']; ?>
">
...
?>
		...
		<li class="current <?php if ($this->_tpl_vars['item']['subs']): ?>has-subs<?php endif; ?> <?php if ($this->_foreach['loop1']['iteration'] > $this->_tpl_vars['half']): ?>second-half<?php endif; ?>"><a href="<?php if ($this->_tpl_vars['item']['homepage'] == 'yes'): ?>/<?php else: ?>/<?php echo $this->_tpl_vars['item']['url']; ?>
...
"><?php if ($this->_tpl_vars['item']['subs']): ?><span><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'Media Page', 'Media') : smarty_modifier_replace($_tmp, 'Media Page', 'Media')); ?>
...
unset($_smarty_tpl_vars);
 ?></li>
		...
		<?php else: ?>
		<li <?php if ($this->_tpl_vars['item']['subs']): ?>class="has-subs  <?php if ($this->_foreach['loop1']['iteration'] > $this->_tpl_vars['half']): ?>second-half<?php endif; ?>"<?php endif; ?>><a href="<?php if ($this->_tpl_vars['item']['homepage'] == 'yes'): ?>/<?php else: ?>/<?php echo $this->_tpl_vars['item']['url']; ?>
/<?php endif; ?>" title="<?php echo ((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'Media Page', 'Media') : smarty_modifier_replace($_tmp, 'Media Page', 'Media')); ?>
"><?php if ($this->_tpl_vars['item']['subs']): ?><span><?php endif; ?><?php echo ((is_array($_tmp=$this->_tpl_vars['item']['title'])) ? $this->_run_mod_handler('replace', true, $_tmp, 'Media Page', 'Media') : smarty_modifier_replace($_tmp, 'Media Page', 'Media')); ?>
<?php if ($this->_tpl_vars['item']['subs']): ?></span><?php endif; ?></a><?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "nav/drop-down-menu.tpl", 'smarty_include_vars' => array('subs' => $this->_tpl_vars['item']['subs'])));
...
"><?php echo $this->_tpl_vars['langs']['Checkout']; ?>
 ...
 display-popdown-widget">
			<a data-target="search-form-popdown" href="#"><?php if ($this->_tpl_vars['search_style'] != 'icon'): ?><?php echo $this->_tpl_vars['langs']['Search']; ?>
<?php endif; ?></a>
		</li>
		<?php endif; ?>
